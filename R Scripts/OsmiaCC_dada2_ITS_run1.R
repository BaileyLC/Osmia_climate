...
### Purpose: Quality control of ITS rRNA data (run 1) using the DADA2 pipeline
...
## Save output ---- 
  saveRDS(seqtab.nochim, file = "OsmiaCC_seqsITS_run1.rds")
  saveRDS(taxa, file = "OsmiaCC_taxaITS_run1.rds")
